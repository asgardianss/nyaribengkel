  ...
  <div class="content-wrapper bg-dark">
    ...
    <div class="card bg-dark">
        ...
        <table>
          <tr>
            <td>
              <a href="input_bengkel_admin.php" class="btn btn-info tombol" role="button">Tambah Data Bengkel</a>
            </td>
          </tr>
        </table>
        <!-- /.card-header -->
          ...
          <table id="example1" class="table table-bordered table-striped">
            <thead>
                ...
                <?php
                  ...
                  $result= mysqli_query($conn, "SELECT * FROM bengkel INNER JOIN kecamatan ON bengkel.id_kecamatan= kecamatan.id_kecamatan");
                ...
                ?>
                  ...
                  <tr>
                    ...
                    <td><?php echo $data['kategori_bengkel']; ?></td>
                    <td><?php echo $data['kecamatan']; ?></td>
                    <td><?php echo $data['latitude']; ?></td>
                    <td><?php echo $data['longitude']; ?></td>
                    <th>
                      <center>
                        <a href="<?php echo "detail_bengkel_admin.php?id_bengkel=".$data['id_bengkel']; ?>" class="btn btn-warning btn-circle btn-sm" data-toggle="tooltip" title="Detail">
                          <i class="fas fa-search"></i>
                        </a>
                        <a href="<?php echo "update_bengkel_admin.php?id_bengkel=".$data['id_bengkel']; ?>" class="btn btn-primary btn-circle btn-sm" data-toggle="tooltip" title="Edit">
                          <i class="fas fa-pencil-alt"></i>
                        </a>
                        <a href="<?php echo "delete_bengkel_admin_action.php?id_bengkel=".$data['id_bengkel']; ?>" class="btn btn-danger btn-circle btn-sm" data-toggle="tooltip" title="Delete">

...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index.php" class="brand-link">
      ...
      <span class="brand-text font-weight-light">PEMETAAN KOST</span>
    </a>
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="view_tempat_kost_admin.php" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Daftar Tempat Kost</p>
                </a>
              </li>
              <li class="nav-item">
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Update Tempat Kost</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item active">Pemetaan Kost</li>
              <li class="breadcrumb-item active">Lokasi Tempat Kost</li>
              <li class="breadcrumb-item active">Daftar Tempat Kost</li>
              <li class="breadcrumb-item">Update Tempat Kost</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    ...
    <section class="content">
      ...
      <div class="card">
        <form autocomplete="off" action="<?php echo "update_tempat_kost_admin_action.php?id_kost=".$data1['id_kost']; ?>" method="POST">
        <div class="card-header">
          ...
          <?php
            if(isset($_GET['input'])){
              ...
              echo "
                <center>
                <div class='alert alert-warning alert-dismissible tulisan'>
          ...
          <tr>
            <td>
              ...
              <div class="form-group">
                <label for="exampleNama">Nama Kost</label>
                <input type="text" class="form-control" id="exampleInputNama" name="nama" required="" value="<?php echo $data1['nama_kost']; ?>">
              </div>
              <div class="form-group">
                <label>Kategori Kost</label>
                <select class="form-control select2" style="width: 100%;" name="kategori">
                  <option value="Laki-laki" <?php if ($data1['kategori_kost']=='Laki-laki'){echo 'selected';}?>>Laki-laki</option>
                  <option value="Perempuan" <?php if ($data1['kategori_kost']=='Perempuan'){echo 'selected';}?>>Perempuan</option>
                </select>
              </div>
              <div class="form-group">
  ...
  <footer class="main-footer bg-dark">
    <center>
      <strong>Copyright &copy; 2022 <a href="https://adminlte.io">Pemetaan Kost</a></strong>
    </center>
  </footer>

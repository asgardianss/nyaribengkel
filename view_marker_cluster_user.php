        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="view_marker_cluster_user.php" class="nav-link active">
            ...
            <td>
              <!-- Main row -->
                ...
                <script type="text/javascript">
                  ...
                  var LayerKita = L.tileLayer('https://tile.openstreetmap.org/{z}/{x}/{y}.png?access_token={accessToken}', {
                  ...
                  var circle = L.circle([-7.747736, 110.355349], {
                      ...
                      fillOpacity: 0.2,
                      radius: 1200
                  }).bindPopup("<b>Radius Bengkel Terdekat</b>").addTo(map);

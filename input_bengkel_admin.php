  ...
  <div class="content-wrapper bg-dark">
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item">Input Bengkel</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    ...
    <section class="content bg-dark">
      ...
      <div class="card bg-dark">
        <form autocomplete="off" action="input_bengkel_admin_action.php" method="POST">
          ...
          <tr>
            <td>
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" id="exampleInputNama" placeholder="Enter Nama Bengkel" name="nama" required="">
              </div>
              <div class="form-group">
                <label>Kategori Bengkel</label>
                <select class="form-control select2" style="width: 100%;" name="kategori">
                  <option selected="selected" value="Motor">Bengkel Motor</option>
                  <option value="Mobil">Bengkel Mobil</option>
                </select>
              </div>
              <div class="form-group">
                <label for="exampleJambuka">Jam Buka</label>
                <input type="time" class="form-control" id="exampleInputJambuka" placeholder="Enter Jam Buka" name="jambuka" required="">
              </div>
              <div class="form-group">
                <label for="exampleJamtutup">Jam Tutup</label>
                <input type="time" class="form-control" id="exampleInputJamtutup" placeholder="Enter Jam Tutup" name="jamtutup" required="">
              </div>
              <div class="form-group">
                <label>Kecamatan</label>
                <select class="form-control select2" style="width: 100%;" name="kecamatan">
                  <option selected="selected" value="1">Sendangadi</option>
                  <option value="2">Sinduadi</option>
                  <option value="3">Trihanggo</option>
                </select>
              </div>
              <div class="row">
                  <!-- left column -->
                  ...
                  <div class="col-md-6">
                      <label for="exampleInputLatitude" class="input">Titik Koordinat</label>
                        <input type="text" id="Latitude" class="form-control" placeholder="Enter Latitude" name="latitude" required="" readonly="">
                        <br>
                        <input type="text" id="Longitude" class="form-control" placeholder="Enter Longitude" name="longitude" required="" readonly="">
                        <br>
              ...
              <br>
              <button type="submit" class="btn btn-primary submit" name="submit">Input Data</button>
              <br>
              <br>
            </td>
          </tr>
...
<script type="text/javascript">
  ...
  if (curLocation[0] == 0 && curLocation[1] == 0) {
    curLocation = [-7.747875373748834, 110.35532949501062];
  }

<?php
    ...
    $dataUbah = mysqli_query($conn, "SELECT * FROM bengkel INNER JOIN kecamatan ON bengkel.id_kecamatan=kecamatan.id_kecamatan WHERE id_bengkel='$id_bengkel'");
  ...
  <div class="content-wrapper bg-dark">
    ...
    <div class="content-header">
      <div class="container-fluid bg-dark">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Daftar Bengkel</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item active">Pemetaan Bengkel</li>
              <li class="breadcrumb-item">Daftar Bengkel</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    ...
    <div class="card bg-dark">
        ...
        <table>
          <tr>
            <td>
              <a href="view_bengkel_admin.php" class="btn btn-info tombol" role="button">Kembali</a>
            </td>
          </tr>
        </table>
        ...
        <div class="card-body bg-dark">
          <div class="card card-primary bg-dark">
            <!-- /.card-header -->
            <div class="card-body">
              <strong><i class="fas fa-user mr-1"></i> Nama Bengkel</strong>

              <p class="text-muted">
                <?php echo $data1['nama_bengkel']; ?>
              </p>

              <hr>

              <strong><i class="fas fa-file mr-1"></i> Kategori</strong>

              <p class="text-muted">
                <?php echo $data1['kategori_bengkel']; ?>
              </p>

              <hr>

              <strong><i class="fas fa-clock mr-1"></i> Jam Buka</strong>

              <p class="text-muted">
                <?php echo $data1['jam_buka']; ?>
              </p>

              <hr>

              <strong><i class="fas fa-clock mr-1"></i> Jam Tutup</strong>

              <p class="text-muted">
                <?php echo $data1['jam_tutup']; ?>
              </p>
              ...
              <p class="text-muted">
                <?php echo $data1['kecamatan']; ?>
              </p>

              <hr>

              <strong><i class="fas fa-map-marker-alt mr-1"></i> Latitude</strong>

              <p class="text-muted">
                <?php echo $data1['latitude']; ?>
              </p>

              <hr>

              <strong><i class="fas fa-map-marker-alt mr-1"></i> Longitude</strong>

              <p class="text-muted">
                <?php echo $data1['longitude']; ?>
              </p>

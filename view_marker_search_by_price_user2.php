        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="view_marker_search_by_price_user.php" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
    ...
    <section class="content bg-dark">
      ...
      <div class="card bg-dark">
        ...
        <table border="0" width="100%">
          <tr>
              <td>
                  <form action="view_marker_search_by_price_user2.php" method="POST" autocomplete="off">
                  <div class="row">
                    <div class="col-md-2">
                      <div class="input-group">
                          <input type="time" class="form-control bg-light border-0 small" placeholder="Dari Jam" aria-label="Search" aria-describedby="basic-addon2" name="jam1" required="">
                      </div>
                    </div>
                    <div class="col-md-2">
                      <div class="input-group">
                          <input type="time" class="form-control bg-light border-0 small" placeholder="Sampai Jam" aria-label="Search" aria-describedby="basic-addon2" name="jam2" required="">
                      </div>   
                    </div>
                    <div class="col-md-2">
                ...
                <script type="text/javascript">
                  ...
                  L.tileLayer('https://tile.openstreetmap.org/{z}/{x}/{y}.png?access_token=pk.eyJ1IjoibWFwYm94IiwiYSI6ImNpejY4NXVycTA2emYycXBndHRqcmZ3N3gifQ.rJcFIG214AriISLbB6B5aw', {
                    ...
                    <?php
                        ...
                        $data2 = mysqli_query($conn,"SELECT * FROM bengkel INNER JOIN kecamatan ON bengkel.id_kecamatan= kecamatan.id_kecamatan WHERE jam_buka >= '$jam1' AND jam_tutup <= '$jam2'");
                        while ($result2= mysqli_fetch_array($data2)){
                        ?>
                        L.marker([<?= $latitude = $result2['latitude']; ?>, <?= $longitude = $result2['longitude']; ?>], {icon:icon1})
                        .bindPopup("<b>Nama Bengkel : <?= $nama_bengkel = $result2['nama_bengkel']; ?></b><br>Kecamatan : <?= $kecamatan = $result2['kecamatan']; ?><br>Kategori : <?= $kategori = $result2['kategori_bengkel']; ?>")
                        .addTo(map);
                        <?php
                        }
